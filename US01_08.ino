...
/** \brief Erkennt den Nutzer anhand seiner RFID-Karten ID, gibt ihn im seriellen Monitor aus und begrüßt ihn auf dem Display
 *  
 */
...
void loop()
{
  ...
  user1.userZugang(); //Begrüßung des Benutzers auf dem Display
  user2.userZugang(); //Begrüßung des Benutzers auf dem Display
}
