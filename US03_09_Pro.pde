...
void setup()
{
  ...
  seriellerPort=new Serial(this,Serial.list()[6],9600);  //Definition des Objekts seriellerPort (baud rate=9600 bauds per second)
...
void draw()
{
  ...
  if(benutzer==1)  //Wenn benutzer=master, dann... (Anzeige der Protokollierung nur für Benutzer mit master Rechten)
  {
