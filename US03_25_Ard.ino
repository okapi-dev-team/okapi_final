...
/** \brief Gibt angelegtes Nutzerkonto zurück
 *  \return Nutzerdaten aus Benutzerkonto
 *  
 */
String User::userAusgeben()
{
...
{
  if(user[3]==rfidScan()) //Identifizierung des Benutzers über Abgleich der ausgelesenen RFID-Karten ID und hinterlegten RFID-Karten IDs
  {
...
/** \brief Auslesen des Wochentags aus RTC und Umwandeln in Kürzel für verkürzte Anzeige
 *  \return String wochentagKurzStr
 * 
 */
String wochentagKurz()
{
...
void uhrzeitDatumDisplay()
{
  ...
  lcd.setCursor(1,1); //Setzen des Cursors auf die 1. Stelle in der 2. Zeile
  lcd.print(wochentagKurz());  //Schreiben der aktuellen Wochentagsabkürzung
  lcd.setCursor(5,1); //Setzen des Cursors auf die 5. Stelle in der 2. Zeile
 ...
 *  \return String rfidFinalStr
 *  
 */
String User::rfidScan()
{
...
void setup()
{
  ...
  //Serial.println(user1.userAusgeben()); //Ausgabe des 1. Nutzerprofils in seriellen Monitor
  //Serial.println(user2.userAusgeben()); //Ausgabe des 2. Nutzerprofils in seriellen Monitor
