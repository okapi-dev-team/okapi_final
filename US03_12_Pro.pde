...
boolean benutzer1Hold=false;  //Initalisierung von bool-Variablen als toggle (true=Benutzer ist angemeldet/hat master Rechte; false=Benutzer ist nicht angemeldet/hat slave Rechte)
...
void draw()
{
  ...
  if(mousePressed==true&&mouseButton==CENTER)  //Wenn mittlere Maustaste gedrückt, dann...
  {
