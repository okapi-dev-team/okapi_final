...
/** \brief Erkennt den Nutzer anhand seiner RFID-Karten ID und stellt bei vorhandenen Rechten die Zugriffsrechte auf volle Rechte
 *  
 */
void User::userZugang()
{
  if(user[3]==rfidFinalStr) //Identifizierung des Benutzers über Abgleich der ausgelesenen RFID-Karten ID und hinterlegten RFID-Karten IDs
  {
    ...
    delay(5000);  //Anzeige des Benutzernames für 5 Sekunden
  }
