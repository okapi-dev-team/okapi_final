...
const int maxTemperatur=30; //Maximale Temperatur auf 30°C festlegt
...
{  
  ...
  if(fenster||(alarmanlageStatus==1&&((messenLuftfeuchtigkeit()>maxLuftfeuchtigkeit)||(messenTemperatur()>maxTemperatur)))) //Wenn Fenster geöffnet werden soll (entweder Taster über GUI oder Überschreitung Messwerte Tmeperatur oder Luftfeuchtigkeit), dann...
  {
